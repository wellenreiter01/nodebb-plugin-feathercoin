...
var walletAddress = $.get(RELATIVE_PATH + '/api/crypto', {}, function(addressData) {
    ...
    if(addressData.address){
    	...
    	var socket = io("http://explorer.feathercoin.com:80/");
		...
		/*
		$.get("http://explorer.feathercoin.com:80/api/tx/fda84b925eaaf5a8bd98f34b382ec457e71170753cbad829699bc4d997533084", function(transDetails,exp) {
		...
		*/
		...
		socket.on(addressData.address, function(data) {
			...
			$.get("http://explorer.feathercoin.com:80/api/tx/" + data, function(transDetails,exp) {
